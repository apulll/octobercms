...
MySQL - 5.5.40 : Database - octobercms
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`octobercms` /*!40100 DEFAULT CHARACTER SET gbk */;
...
insert  into `backend_access_log`(`id`,`user_id`,`ip_address`,`created_at`,`updated_at`) values (1,1,'127.0.0.1','2017-06-06 01:50:15','2017-06-06 01:50:15');
...
insert  into `backend_user_groups`(`id`,`name`,`permissions`,`created_at`,`updated_at`,`code`,`description`,`is_new_user_default`) values (1,'Owners',NULL,'2017-06-06 01:49:44','2017-06-06 01:49:44','owners','Default group for website owners.',0);
...
insert  into `backend_users`(`id`,`first_name`,`last_name`,`login`,`email`,`password`,`activation_code`,`persist_code`,`reset_password_code`,`permissions`,`is_activated`,`activated_at`,`last_login`,`created_at`,`updated_at`,`is_superuser`) values (1,'Admin','Person','admin','1216065136@qq.com','$2y$10$yFfzWN9WS5uGG6ls.MalZeEzBggtBvHLkHB/dC3iWf67bU7lTiTR6',NULL,'$2y$10$NVKb3/YsPrk7v77ieMzZUuuFtvkKdvXlrxgKWpzBftKTy6E2aw7/.',NULL,'',1,NULL,'2017-06-06 01:50:15','2017-06-06 01:49:44','2017-06-06 01:50:15',1);
...
insert  into `system_mail_layouts`(`id`,`name`,`code`,`content_html`,`content_text`,`content_css`,`is_locked`,`created_at`,`updated_at`) values (1,'Default','default','<html>\n    <head>\n        <style type=\"text/css\" media=\"screen\">\n            {{ css|raw }}\n        </style>\n    </head>\n    <body>\n        {{ content|raw }}\n    </body>\n</html>','{{ content|raw }}','a, a:hover {\n    text-decoration: none;\n    color: #0862A2;\n    font-weight: bold;\n}\n\ntd, tr, th, table {\n    padding: 0px;\n    margin: 0px;\n}\n\np {\n    margin: 10px 0;\n}',1,'2017-06-06 01:49:44','2017-06-06 01:49:44'),(2,'System','system','<html>\n    <head>\n        <style type=\"text/css\" media=\"screen\">\n            {{ css|raw }}\n        </style>\n    </head>\n    <body>\n        {{ content|raw }}\n        <hr />\n        <p>This is an automatic message. Please do not reply to it.</p>\n    </body>\n</html>','{{ content|raw }}\n\n\n---\nThis is an automatic message. Please do not reply to it.','a, a:hover {\n    text-decoration: none;\n    color: #0862A2;\n    font-weight: bold;\n}\n\ntd, tr, th, table {\n    padding: 0px;\n    margin: 0px;\n}\n\np {\n    margin: 10px 0;\n}',1,'2017-06-06 01:49:44','2017-06-06 01:49:44');
...
insert  into `system_parameters`(`id`,`namespace`,`group`,`item`,`value`) values (1,'system','update','count','0'),(2,'system','core','hash','\"386846ebe3802c4f192625743abb3f06\"'),(3,'system','core','build','\"419\"'),(4,'system','update','retry','1496800219');
...
insert  into `system_plugin_history`(`id`,`code`,`type`,`version`,`detail`,`created_at`) values (1,'October.Demo','comment','1.0.1','First version of Demo','2017-06-06 01:49:44');
...
insert  into `system_plugin_versions`(`id`,`code`,`version`,`created_at`,`is_disabled`,`is_frozen`) values (1,'October.Demo','1.0.1','2017-06-06 01:49:44',0,0);
